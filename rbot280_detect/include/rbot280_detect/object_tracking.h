...
#ifndef PROJECT_ObjectTracking_H
#define PROJECT_ObjectTracking_H

#define __APP_NAME__ "object_tracking"
...
#include <rbot_msgs/ClassificationArray.h>
#include <rbot_msgs/Classification.h>
...
class ObjectTracking
{
  ...
  ros::Subscriber classification_sub_;
  ...
  void ClassificationCb(const rbot_msgs::ClassificationArray& in_classification_msg);
 ...
 public:
  void Run();
 ObjectTracking() : it_(nh_){};
  virtual ~ObjectTracking();

};
#endif //PROJECT_OBJECT_TRACKING_H
